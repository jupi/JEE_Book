...
• Podemos sobrescribir estos métodos para defi nir el formato de impresión de los objetos
de nuestras clases y el criterio de comparación (respectivamente).
• “Sobrescribir” signifi ca reescribir el cuerpo de un método que estamos heredando
(sin modifi car su prototipo o encabezado).
